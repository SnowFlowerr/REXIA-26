    ...
    events: [
      {
        ...
        rules: [
          "Open to college students across India — valid College ID and Government ID mandatory.",
          "Team size: minimum 2, maximum 5 members. All must be officially registered.",
          ...
          "*Prize pool may increase or decrease according to participant registration."
        ],
        judgementCriteria: [
    ...
    events: [
      {
        ...
        snapshots: [
          { round: "Knockouts", format: "Best of 3", duration: "", eliminates: "Yes" },
          { round: "Finals", format: "Best of 3", duration: "", eliminates: "No" }
        ],
        rules: [
          "Open to college students across India — valid College ID and Government ID mandatory.",
      ...
      },
      {
        ...
        snapshots: [
          { round: "Qualifiers", format: "1 Set", duration: "", eliminates: "Yes" },
          { round: "Finals", format: "Best of 3 Sets", duration: "", eliminates: "No" }
        ],
        rules: [
          "Open to college students across India — valid College ID and Government ID mandatory.",
      ...
      },
      {
        ...
        snapshots: [
          { round: "Swiss Rounds", format: "10+5 Rapid", duration: "", eliminates: "No" }
        ],
        rules: [
          "Open to college students across India — valid College ID and Government ID mandatory.",
      ...
      },
      {
        ...
        snapshots: [
          { round: "Knockouts", format: "Best of 3 pulls", duration: "", eliminates: "Yes" }
        ],
        rules: [
          "Open to college students across India — valid College ID and Government ID mandatory.",
      ...
      },
      {
        ...
        snapshots: [
          { round: "Qualifiers", format: "2 Matches", duration: "", eliminates: "Yes" },
          { round: "Finals", format: "4 Matches", duration: "", eliminates: "No" }
        ],
        rules: [
          "Open to college students across India — valid College ID and Government ID mandatory.",
      ...
      },
      {
        ...
        snapshots: [
          { round: "Group Stage", format: "Round Robin", duration: "", eliminates: "Bottom 50%" },
          { round: "Knockouts", format: "Best of 3 sets", duration: "", eliminates: "Yes" },
          { round: "Finals", format: "Best of 5 sets", duration: "", eliminates: "No" }
        ],
        rules: [
          "Open to college students across India — valid College ID and Government ID mandatory.",
    ...
    events: [
      {
        ...
        snapshots: [
          { round: "Finals", format: "Stage Performance", duration: "", eliminates: "No" }
        ],
        rules: [
          "Open to college students across India — valid College ID and Government ID mandatory.",
